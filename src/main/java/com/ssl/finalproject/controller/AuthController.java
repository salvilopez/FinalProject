...
@RestController
@RequestMapping("/auth")
@CrossOrigin(origins = "https://proyecto-ingenia-angular-biq7cnytj-salvilopez.vercel.app", methods= {RequestMethod.GET,RequestMethod.POST,RequestMethod.PUT,RequestMethod.DELETE})
