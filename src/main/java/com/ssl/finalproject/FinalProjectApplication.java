...
public class FinalProjectApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Tag tag1 = new Tag("tag1", Instant.now(),Instant.now(),"salvi@gmail.com");
        Tag tag2 = new Tag("tag2",Instant.now(),Instant.now(),"pepe@@gmail.com");
        Tag tag3 = new Tag("tag3",Instant.now(),Instant.now(),"manuel@gmail.com");
        Tag tag4 = new Tag("tag4",Instant.now(),Instant.now(),"salvi@gmail.com");
